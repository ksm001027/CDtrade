...
%>
<div class="review-block" onclick="location.href='album-detail.jsp?albumNo=<%=review.getAlbum().getNo()%>'">
    <div class="review-album-cover">
        <img src="${pageContext.request.contextPath}/<%=review.getAlbum().getCoverImageUrl()%>" alt="앨범 커버" onerror="this.src='${pageContext.request.contextPath}/resources/images/default-album.jpg'">
    </div>
    <div class="review-content">
        ...
        <div class="review-user-info">
            ...
            <span class="user-name"><%=review.getUser().getNickname() != null ? review.getUser().getNickname() : review.getUser().getName()%></span>
        </div>
                ...
                <div id="genre-modal" class="genre-modal">
                    <div class="genre-modal-content">
                        ...
                        <div class="genre-modal-body">
                            <ul class="genre-list">
                                <li><a href="review-list.jsp" class="genre-item <%=genreNo == 0 ? "active" : ""%>">전체</a></li>

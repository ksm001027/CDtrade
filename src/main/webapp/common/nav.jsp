    ...
    <nav class="main-navbar">
        <div class="navbar-inner">
            ...
            <ul class="navbar-menu">
                <li><a href="../album/best-album-list.jsp">베스트</a></li>
                <li class="dropdown">
...
%>	
					 <li><a href="../album/genre-album-list.jsp?genreNo=<%=entry.getKey()%>"><%=entry.getValue()%></a></li>
<%
	};
%>
			      </ul>
			    </li>
                <li><a href="../review-list.jsp">최신리뷰</a></li>
                <li><a href="#">판매상품</a></li>
            </ul>
